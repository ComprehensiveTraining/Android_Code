...
public class HotUserAdapter extends RecyclerView.Adapter<HotUserAdapter.ViewHolder>{
    ...
    public HotUserAdapter(List<the_collection> CardList) {
        cardList = CardList;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.hot_user_item, parent, false);
    ...
    @Override
    public void onBindViewHolder(final HotUserAdapter.ViewHolder holder, final int position) {
